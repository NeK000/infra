...
module "lxc" {
  ...
  raw_lxc_config                   = each.value.raw_lxc_config
  raw_lxc_config_ssh_host          = each.value.raw_lxc_config_ssh_host
  post_create_reboot_delay_seconds = each.value.post_create_reboot_delay_seconds
